...
This is the packaged front-camera semantic-segmentation model trained from
`bettersetup_v4`. It predicts one mutually exclusive class ID per pixel.
...
From `/data/qihan/sam2`:

```bash
/home/qihan/miniconda3/envs/sam2/bin/python tools/infer_light_semseg.py \
  --model-dir /data/qihan/sam2/segdata/final/bettersetup_v4/models/unet_front_v4_r1 \
